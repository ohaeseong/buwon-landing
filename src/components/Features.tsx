  ...
  const features = [
    {
      ...
      title: "품질 보증",
      description:
        "엄격한 품질 관리 시스템과 고급 원자재 사용으로 최고 품질을 보장합니다.",
    ...
    },
    {
      ...
      title: "맞춤 제작",
      description:
        "고객의 특별한 요구사항을 반영한 완전 맞춤형 디자인과 제작 서비스를 제공합니다.",
    ...
    },
    {
      ...
      title: "신속 납기",
      description:
        "효율적인 생산 시스템으로 빠른 제작과 배송, 설치 서비스를 제공합니다.",
    ...
    },
    {
      ...
      title: "A/S 지원",
      description:
        "제품 설치 후에도 지속적인 관리와 유지보수 서비스를 제공합니다.",
      ...
      <div className="container-max-width section-padding">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            20년 이상 축적된 경험과 전문성을 바탕으로 고객에게 최고의 가치를
            제공합니다.
          </p>
        </div>
